...
exports.findAll = (req, res) => {
  ...
  // If no ID is passed in the URL (?id=...), condition is null and returns all
  var condition = id ? { EmployeeID: { [Op.like]: `%${id}%` } } : null;
...
exports.update = (req, res) => {
  ...
  logger.debug(`Updating employee ${id} with data: ${JSON.stringify(req.body)}`);
